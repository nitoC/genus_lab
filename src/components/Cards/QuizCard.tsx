const QuizCard = ({ title, time }: { title: string; time: string }) => (
  <div className="bg-white dark:bg-zinc-800/20 dark:text-white text-black rounded-xl shadow-lg p-4 transition-transform hover:scale-105 duration-300 ease-in-out">
    <img
